...
Finally we have the playback pipeline. Once again this operates in a separate thread to the main thread, reading packets from the network "transfer buffer", parsing them and playing them back.
